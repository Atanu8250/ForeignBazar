          ...
          <Box
            ...
            <Container size="container.lg" height="400px" position="relative" >
              <Stack
                ...
                <Text fontSize={{ base: 'md', lg: 'lg' }} color="GrayText" pl={{sm:'0', md: index === 1 ? '100px' : '0px'}}>
                  {card.text}
                </Text>
              <HStack justifyContent="space-around" textDecoration="underline" pl={{sm:'0', md: index === 1 ? '100px' : '0px'}}>
