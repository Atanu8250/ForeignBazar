    ...
    <Container maxW='9xl' padding='20px'>
        <Flex w='100%' justifyContent='space-between' alignItems='center'>
            ...
            <Flex direction='column' alignItems="center" gap='10px' >
                <Text fontWeight="bolder" fontSize={{ sm:"8px", md:"18px",}}>Shop what you love—faster and easier.</Text>
                <Link style={{textDecoration:"underline"}}  to='/signin'>Sign In or Create an Account</Link>
            </Flex>
