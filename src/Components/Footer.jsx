...
export default function Footer() {
    return (
        <Box
            ...
            color={useColorModeValue('gray.700', 'gray.200')} pr="80px">
                    ...
                    <Stack align={'flex-start'}>
                        <ListHeader>
                            <svg width="24px" height="24px" focusable="false" className="nui-icon nui-icon-large-apps ">
                                <g id="Originals">
                                    <path className="nui-icon-large-apps-1" d="M12.964 21.014v2.485h7.4a.384.384 0 0 0 .374-.394v-2.091h-7.774z"></path>
                                    <path className="nui-icon-large-apps-28" d="M12.964 23.499h7.4a.374.374 0 0 0 .374-.375V.874a.374.374 0 0 0-.374-.375H5.678a.374.374 0 0 0-.374.375v6.115"></path>
                                    <path className="nui-icon-large-apps-1" d="M20.345.499H5.698a.393.393 0 0 0-.394.394v1.745h15.434V.893a.393.393 0 0 0-.393-.394zM11.308 8.668V23H3.762V8.668h7.546m.605-1H3.157a.395.395 0 0 0-.395.395v15.542c0 .218.176.395.395.395h8.756a.395.395 0 0 0 .395-.395V8.063a.395.395 0 0 0-.395-.395z"></path>
                                    <path className="nui-icon-large-apps-1" d="M2.762 21.013v2.592c0 .218.176.395.395.395h8.756a.395.395 0 0 0 .395-.395v-2.592H2.762zM11.913 7.668H3.157a.395.395 0 0 0-.395.395v2.16h9.546v-2.16a.395.395 0 0 0-.395-.395z"></path>
                                    <path className="nui-icon-large-apps-2" d="M13.565 1.586h-1.087a.28.28 0 0 1 0-.558h1.087a.28.28 0 0 1 0 .558zM7.539 22.999a.522.522 0 0 1-.52-.528c0-.291.23-.528.52-.528a.53.53 0 0 1 .536.528.531.531 0 0 1-.536.528zM8.061 9.254H7.009a.27.27 0 0 1 0-.54h1.052a.27.27 0 0 1 0 .54z"></path>
                                </g>
                            </svg>
                            Install App
                        </ListHeader>
